...
export default async function InsightSinglePage({ params }) {
            ...
            <aside className="w-full lg:w-72 lg:flex-shrink-0 flex flex-col gap-8">
              ...
              <div className="bg-gray-50 rounded-2xl p-6">
                ...
                <div className="flex gap-3">
                  {[
                    { label: "LinkedIn", href: `https://linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(`/insights/${slug}`)}`, icon: <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z M4 6a2 2 0 100-4 2 2 0 000 4z" /> },
                    { label: "Twitter", href: `https://x.com/intent/tweet?url=${encodeURIComponent(`/insights/${slug}`)}&text=${encodeURIComponent(title.replace(/<[^>]+>/g, ""))}`, icon: <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" /> },
                    { label: "Facebook", href: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(`/insights/${slug}`)}`, icon: <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" /> },
                  ].map(({ label, href, icon }) => (
                    <a
                      key={label}
                      href={href}
